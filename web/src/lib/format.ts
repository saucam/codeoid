/**
 * Display formatters. Used everywhere usage metrics surface — keep them
 * pure, deterministic, and test-covered. The underlying signals stay raw
 * so derived calcs (e.g. cost-per-turn averages) don't drift.
 */
